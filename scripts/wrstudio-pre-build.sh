...
git -C meta-javascripts checkout 9a0c97e935a8bc4e17a62baa7f619ff5aa295742
git clone --single-branch --branch master ${GITLAB_URL}/phallsma/meta-marine-instruments.git
git -C meta-marine-instruments checkout 9ab86ccb5f3c7b429badcf8d9563b32c50582a01
